...
<main>
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark col-sm-3" style="width: 280px;height:100%;">
        <a href="#" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
            <h1 id="log" style="padding-left:55px">Video</h1>
        </a>
        <hr>
...
<script>
    $(function () {
        ...
        $.ajax({
            url: '${pageContext.request.contextPath}/getAllVideoAdmin',
            type: 'post',
            ...
            success: function (data) {
                ...
                for (let i = 0; i < data.length; i++) {
                    ...
                    tr += '<td ><a  class="op'+i+'" href=""></a></td>';
                    tr += "</tr>";
                    $('table').append(tr);
                    let temps='.op'+i;
                    $(temps).append(isEorp(data[i].ischeck+''));
                    $(temps).attr("href","${pageContext.request.contextPath}"+'/check?videos='+data[i].id);
                };
            },
