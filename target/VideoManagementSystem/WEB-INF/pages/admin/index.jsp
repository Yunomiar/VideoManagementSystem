...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/sidebars.css">
...
<main>
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark col-sm-3" style="width: 280px;height:100%;">
        <a href="#" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
            <h1 style="padding-left:55px" id="log">Video</h1>
        </a>
        <hr>
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <a href="${pageContext.request.contextPath}/videos" class="nav-link text-white">
                    <svg class="bi me-2" width="16" height="16">
            ...
            <li>
                <a href="${pageContext.request.contextPath}/view" class="nav-link text-white">
                    <svg class="bi me-2 active" width="16" height="16">
    ...
    <div class="b-example-divider" style="width:0.5rem"></div>
    ...
    <noscript id="tpl-user">
        ...
        <div class="layui-card" id="userinfo">
            ...
            <div class="layui-card-body">
                <form class="layui-form" action="${pageContext.request.contextPath}/user/updateUser" lay-filter="info"
                      method="post">
                    <div class="layui-form-item">
                        <label class="layui-form-label layui-required">用户名</label>
                        <div class="layui-input-block">
                            <input type="text" name="username" lay-verify="required" readonly="readonly"
                                   class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" lay-verify="required" lay-reqtext="姓名不为空" placeholder="请输入" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="password" lay-verify="pass" placeholder="请输入密码"
                                   autocomplete="off"
                                   class="layui-input">
                        </div>
...
<script>
    layui.use('table', function () {
        ...
        table.render({
            ...
            , title: '用户数据表'
            , cols: [[
                {field: 'id', title: 'ID', unresize: true, width: 180, sort: true}
                , {field: 'username', width: 240, title: '用户名'}
                , {field: 'name', width: 240, title: '姓名'}
                , {field: 'birthday', width: 240, title: '生日'}
                , {field: 'regdate', width: 240, title: '注册时间'}
                , {
                    field: 'email', width: 240, title: '邮箱', templet: function (res) {
